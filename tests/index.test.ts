...
import { APIPromise } from 'oli-embedded-mcp/core/api-promise';

import util from 'node:util';
import OliEmbeddedMcp from 'oli-embedded-mcp';
import { APIUserAbortError } from 'oli-embedded-mcp';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['OLI_EMBEDDED_MCP_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: OliEmbeddedMcp) => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new OliEmbeddedMcp({ logger: logger, logLevel: 'debug', baseurl: 'My-Baseurl' });
    ...
    test('default logLevel is warn', async () => {
      const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new OliEmbeddedMcp({ logger: logger, logLevel: 'info', baseurl: 'My-Baseurl' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['OLI_EMBEDDED_MCP_LOG'] = 'debug';
      const client = new OliEmbeddedMcp({ logger: logger, baseurl: 'My-Baseurl' });
    ...
    test('warn when env var level is invalid', async () => {
      ...
      process.env['OLI_EMBEDDED_MCP_LOG'] = 'not a log level';
      const client = new OliEmbeddedMcp({ logger: logger, baseurl: 'My-Baseurl' });
      expect(client.logLevel).toBe('warn');
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'OLI_EMBEDDED_MCP_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['OLI_EMBEDDED_MCP_LOG'] = 'debug';
      const client = new OliEmbeddedMcp({ logger: logger, logLevel: 'off', baseurl: 'My-Baseurl' });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['OLI_EMBEDDED_MCP_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new OliEmbeddedMcp({ baseURL: 'https://example.com', baseurl: 'My-Baseurl' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['OLI_EMBEDDED_MCP_BASE_URL'] = 'https://example.com/from_env';
      const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['OLI_EMBEDDED_MCP_BASE_URL'] = ''; // empty
      const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl' });
      expect(client.baseURL).toEqual('http://My-Baseurl}');
    });

    test('blank env variable', () => {
      process.env['OLI_EMBEDDED_MCP_BASE_URL'] = '  '; // blank
      const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl' });
      expect(client.baseURL).toEqual('http://My-Baseurl}');
    });
  });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new OliEmbeddedMcp({ maxRetries: 4, baseurl: 'My-Baseurl' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new OliEmbeddedMcp({ baseurl: 'My-Baseurl' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['OLI_EMBEDDED_MCP_BASEURL'] = 'My-Baseurl';
    const client = new OliEmbeddedMcp();
    expect(client.baseurl).toBe('My-Baseurl');
  });

  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['OLI_EMBEDDED_MCP_BASEURL'] = 'another My-Baseurl';
    const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl' });
    expect(client.baseurl).toBe('My-Baseurl');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new OliEmbeddedMcp({ baseurl: 'My-Baseurl', fetch: testFetch });
