import fs from 'fs';
import type { ResponseLike } from 'oli-embedded-mcp/internal/to-file';
import { toFile } from 'oli-embedded-mcp/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('oli-embedded-mcp/core/uploads');
    await expect(
